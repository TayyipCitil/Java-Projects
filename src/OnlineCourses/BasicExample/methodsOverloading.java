...
public class methodsOverloading { //18.ders Method lar ve overloading
    public static void main(String[] args) {//method ismindeki "void" parametre göndermeyen/vermiyen method anlamına gelir
        ...
        methodsOverloading example = new methodsOverloading();  /*Bu satır, methodsOverloading sınıfının  aynı isimdeki
